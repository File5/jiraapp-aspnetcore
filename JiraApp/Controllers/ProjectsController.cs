...
namespace JiraApp.Controllers
{
    public class ProjectsController : Controller
    {
        ...
        {
            var jiraContext = _context.Projects.Include(p => p.Person);
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,StartDate,EndDate,PersonId")] Project project)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,StartDate,EndDate,PersonId")] Project project)
        {
            if (id != project.Id)
            {
                return NotFound();
